...
BEGIN
  ...
  DECLARE @IsResumableEdition int = CASE WHEN (@Version >= 14) OR (@Version >= 12 AND SERVERPROPERTY('Edition') = 'SQL Azure') THEN 1 ELSE 0 END
