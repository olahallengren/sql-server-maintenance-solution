...
SQL Server Maintenance Solution - SQL Server 2005, SQL Server 2008, SQL Server 2008 R2, 
...
SET @BackupDirectory     = N'\\schain-dbk\SQLCluster\' -- Specify the backup root directory.
...
SET @OutputFileDirectory = N'\\schain-dbk\SQLCluster\MaintenanceLogs\'         -- Specify the output file directory. If no directory is specified, then the SQL Server error log directory is used.
...
BEGIN
  ...
  SET @JobDescription = 'Database Maintenance Source: https://ola.hallengren.com'
  SET @JobCategory = 'Database Maintenance'
  SET @JobOwner = SUSER_SNAME(0x01)

  SET @JobName01 = '_DBA_DatabaseBackup - SYSTEM_DATABASES - FULL'
  ...
  SET @JobName02 = '_DBA_DatabaseBackup - USER_DATABASES - DIFF'
  ...
  SET @JobName03 = '_DBA_DatabaseBackup - USER_DATABASES - FULL'
  ...
  SET @JobName04 = '_DBA_DatabaseBackup - USER_DATABASES - LOG'
  ...
  SET @JobName05 = '_DBA_DatabaseIntegrityCheck - SYSTEM_DATABASES'
  ...
  SET @JobName06 = '_DBA_DatabaseIntegrityCheck - USER_DATABASES'
  ...
  SET @JobName07 = '_DBA_IndexOptimize - USER_DATABASES'
  ...
  SET @JobName08 = '_DBA_sp_delete_backuphistory'
  ...
  SET @JobName09 = '_DBA_sp_purge_jobhistory'
  ...
  SET @JobName10 = '_DBA_Output File Cleanup'
  ...
  SET @JobName11 = '_DBA_CommandLog Cleanup'
